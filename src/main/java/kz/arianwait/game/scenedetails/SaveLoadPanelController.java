...
import kz.arianwait.game.actionscenarios.SaveManager;
import kz.arianwait.game.animation.AnimationUtils;
...
import kz.arianwait.game.fileutils.FileUtils;
import kz.arianwait.game.mainscene.LoadingScreen;
import kz.arianwait.game.scenelist.GameData;
import kz.arianwait.game.scenelist.SceneBuilder;
...
public class SaveLoadPanelController extends VBox {
    ...
    public void showPanel(StackPane root) {
        this.root = root;
        kz.arianwait.game.utils.OverlayMarker.mark(menuPanel);
