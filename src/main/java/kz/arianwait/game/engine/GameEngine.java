package kz.arianwait.game.engine;
...
import kz.arianwait.game.engine.model.HistoryStep;
import kz.arianwait.game.engine.model.PuzzleCommand;
import kz.arianwait.game.engine.model.AnimationCommand;
import kz.arianwait.game.engine.model.SceneFrame;
import kz.arianwait.game.engine.model.SoundCommand;
import kz.arianwait.game.engine.model.StateCommand;
import kz.arianwait.game.engine.model.StopEffectCommand;
import kz.arianwait.game.engine.model.VisualEffectCommand;
import kz.arianwait.game.engine.model.VisualState;
...
import kz.arianwait.game.panel.GamePanel;
import kz.arianwait.game.panel.PanelContext;
import kz.arianwait.game.panel.PuzzleRegistry;
import kz.arianwait.game.engine.model.ChoiceOption;
import kz.arianwait.game.scenedetails.DialogChoicesController;
import kz.arianwait.game.mainscene.TitlesAnimation;
import kz.arianwait.game.scenedetails.NameInputPane;
import kz.arianwait.game.scenedetails.DialogPanel;
import kz.arianwait.game.scenelist.GameData;
import kz.arianwait.game.scenelist.SceneController;
import kz.arianwait.game.scenelist.SceneInfo;
import kz.arianwait.game.soundtrack.SoundEffect;
import kz.arianwait.game.utils.OverlayMarker;
...
public class GameEngine {
    ...
    public void initializeAndLoadAll() {
        kz.arianwait.game.engine.resources.CharacterLibrary.initialize();
