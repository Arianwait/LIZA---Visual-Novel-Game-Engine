package kz.arianwait.game.engine.render;
...
import kz.arianwait.game.engine.effect.VisualEffectPlayer;
import kz.arianwait.game.engine.effect.VisualEffectRegistry;
...
import kz.arianwait.game.scenedetails.DimOverlay;
...
import kz.arianwait.game.soundtrack.SoundManager;
import kz.arianwait.game.utils.ImageViewPool;
import kz.arianwait.game.utils.ResourceLocator;
import kz.arianwait.game.utils.VariableSubstitution;
...
public class SceneRenderer {
    ...
    private void applyThemeSwitch(SceneFrame frame) {
        if (frame.getSwitchToTheme() != null && !frame.getSwitchToTheme().isEmpty()) {
            kz.arianwait.game.appsettings.AppSettings appSettings = SceneInfo.getAppSettings();
            if (appSettings != null) {
