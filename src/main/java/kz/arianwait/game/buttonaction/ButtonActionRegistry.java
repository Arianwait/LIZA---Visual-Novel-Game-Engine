 ...
 * Новые действия: создай класс с {@link ButtonAction} и реализуй {@link ButtonActionHandler} в пакете {@code kz.arianwait.game.buttonaction} — регистрация автоматическая.
 */
public final class ButtonActionRegistry {
    ...
    private static final String ACTION_PACKAGE = "kz.arianwait.game.buttonaction";
