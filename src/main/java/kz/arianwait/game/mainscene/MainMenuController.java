...
import kz.arianwait.game.utils.UiConfigParser.ButtonConfig;
...
public class MainMenuController extends VBox {
    ...
    private static boolean isConditionMet(String condition) {
        if ("hasSaveFiles".equals(condition)) {
            return kz.arianwait.game.actionscenarios.SaveSlots.hasAnySave();
        }
        return true;
    }
    ...
    private void createButtons() {
        ...
        List<ButtonConfig> buttonConfigs = kz.arianwait.game.utils.UiConfigParser
