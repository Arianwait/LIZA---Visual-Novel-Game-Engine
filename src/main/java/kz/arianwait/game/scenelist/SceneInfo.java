package kz.arianwait.game.scenelist;
...
import kz.arianwait.game.engine.GameEngine;
...
public  class SceneInfo {
	...
	private static kz.arianwait.game.panel.BaseGamePanel activePuzzle;

	/** Устанавливает активный паззл (null — паззл завершён). */
	public static void setActivePuzzle(kz.arianwait.game.panel.BaseGamePanel panel) { activePuzzle = panel; }
	...
	public static kz.arianwait.game.panel.BaseGamePanel getActivePuzzle() { return activePuzzle; }
