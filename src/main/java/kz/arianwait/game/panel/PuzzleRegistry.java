 ...
 *
 * <p>Автоматически находит все классы в пакете {@code kz.arianwait.game.panel},
 ...
 *
 * <p>Добавить новую панель: создать класс (в любом подпакете {@code kz.arianwait.game.panel}),
...
public final class PuzzleRegistry {
    ...
    private static final String PANEL_PACKAGE = "kz.arianwait.game.panel";
